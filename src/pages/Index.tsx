    ...
    <>
      ...
      <div className="container mx-auto px-6 py-24">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/40 mb-8 glow-primary backdrop-blur-xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-20">
          {features.map((feature, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="glass-card hover:scale-105 transition-smooth group cursor-pointer relative overflow-hidden border-2 border-primary/20 hover:border-primary/40"
              >
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div key={item.step} className="text-center group">
                <div className={`relative w-20 h-20 rounded-3xl bg-gradient-to-br ${item.gradient} flex items-center justify-center mx-auto mb-6 text-3xl font-black text-white glow-primary group-hover:scale-125 transition-smooth`}>
